...
| Automazione Posta-Documenti-Gdrive | none | M001 E.ON Drive/Sheets OAuth unlocked 2026-09-21: credential Drive CONNECTED; WF06 REUSE + WF07 Sheets upsert canaries PASS; WF10 orchestrator ACTIVE (WF02→WF07); active map **6** (4 CP + WF01 + WF10); gates cleared DRIVE/SHEETS OAuth; payment/Gmail-write/sample parsers still gated; `SECRETS_EXPOSED=0` | PostgreSQL, n8n, `/root/local-files`, Google Drive/Sheets | DEPLOYED_VALIDATED | #107–#131; app #2–#17; evidence `maildocs_m001_v1_end_to_end_macro_evidence_v1.md` |
