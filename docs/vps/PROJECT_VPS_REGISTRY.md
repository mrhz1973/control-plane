...
| Automazione Posta-Documenti-Gdrive | none | R002 COMPLETE + R003B/C/D/E 2026-09-20: DB `maildocs` / `maildocs_app` / schema `maildocs`; WF01 ACTIVE 15m shadow; WF02 INACTIVE attachment SHA-256/dedupe canary PASS (`17331f9`); dual no-redownload + Gmail before==after + active map 5; n8n/containers/listeners unchanged; `SECRETS_EXPOSED=0` | PostgreSQL, n8n, `/root/local-files` | DEPLOYED_VALIDATED | #107; #111; #112; #114; #117; #119; #122; #124; app #2–#11; evidence `r002_*` + `r003b/c/d/e_maildocs_*` |
