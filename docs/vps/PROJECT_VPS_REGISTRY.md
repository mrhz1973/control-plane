...
| Automazione Posta-Documenti-Gdrive | none | R002 COMPLETE 2026-09-20: DB `maildocs` / role `maildocs_app` / schema `maildocs` on `root-postgres-1`; migrations `001_core`+`002_retry_state` (double-run idempotent); runtime root checkout `2d28b84`; R002A credential+smoke PASS; R002B/B.1 repository+SHA immutability; R002C live repository canary PASS; R002D retry state machine live canary PASS (run `r002d-20260920T075100Z-2d28b84`, scenarios A/B/C/D, residual 0); n8n/containers/listeners unchanged; `SECRETS_EXPOSED=0` | PostgreSQL, n8n, `/root/local-files` | DEPLOYED_VALIDATED | #107; #111; #112; #114; app issues #2/#3/#4/#5/#6; `reports/architecture/r002_maildocs_vps_db_bootstrap_evidence_v1.md`; `reports/architecture/r002a_maildocs_n8n_postgres_credential_smoke_evidence_v1.md`; `reports/architecture/r002c_maildocs_repository_live_postgres_canary_evidence_v1.md`; `reports/architecture/r002d_maildocs_retry_state_live_canary_evidence_v1.md` |
