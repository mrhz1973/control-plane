...
| Automazione Posta-Documenti-Gdrive | none | M001 E.ON end-to-end ACTIVE; **R005 COMPLETE** 2026-09-22: WF06 `m001-r005-live-v4` create-if-absent + post-write SHA + missing-doc detector PASS (REAL_CREATE_CANARY=NOT_AVAILABLE; synthetic `2099-01-01_R005CANARY.pdf`); WF07 Sheets upsert PASS; WF10 orchestrator ACTIVE (WF02→WF07); active map **6** (4 CP + WF01 + WF10); payment/Gmail-write/sample parsers still gated; `SECRETS_EXPOSED=0` | PostgreSQL, n8n, `/root/local-files`, Google Drive/Sheets | DEPLOYED_VALIDATED | #107–#131; app evidence `r005_drive_create_missing_document_evidence_v1.md` + `maildocs_m001_v1_end_to_end_macro_evidence_v1.md` |
