...
| Automazione Posta-Documenti-Gdrive | none | R002 COMPLETE + R003B/C/D/E/E.1 2026-09-20: DB `maildocs` + migration `003_attachment_part_identity`; WF01 ACTIVE; WF02 INACTIVE partId identity PASS (`0e54d25`); dual no-redownload; Gmail before==after; active map 5; `SECRETS_EXPOSED=0` | PostgreSQL, n8n, `/root/local-files` | DEPLOYED_VALIDATED | #107; #111–#114; #117; #119; #122; #124; #125; app #2–#12; evidence `r002_*` + `r003b/c/d/e/e1_maildocs_*` |
