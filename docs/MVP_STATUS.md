...
| **OpenClaw / PM-34 gate (current)** | strict_pass [dry-run package](sessions/2026-05-23-control-plane-strict-pass-dry-run-package.md) prepared — runtime gate still required · PM-34 real worker **gated** · `n8n_ready` **false** · `strict_pass_candidate` **false** |
