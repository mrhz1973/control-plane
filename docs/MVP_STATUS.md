...
| **PM-51 OpenClaw gateway no-op** | **PASS** (manual, casa) — [session](sessions/2026-05-22-control-plane-pm51-openclaw-confined-gateway-noop-probe-pass.md) · PM-34 **blocked** · next **PM-52** design (separate gate) |
