...
| **OpenClaw / PM-34 gate (current)** | Preview reconciled (`0eafafc`) — PM-34 real worker **gated** · `n8n_ready` **false** · `strict_pass_candidate` **false** · next allowed: [strict_pass dry-run design](sessions/2026-05-23-control-plane-pm34-next-gate-design.md) only |
