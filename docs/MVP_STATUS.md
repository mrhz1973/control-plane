...
| **PM-26/27/28 stabilization** | **PREPARED** — post-promotion docs — [batch](sessions/2026-05-22-control-plane-pm26-pm28-post-promotion-stabilization-batch.md) |
...
| **PM-40 strict structured retry** | **BLOCKED_BY_TOOL_POLICY** — no strict pass; PM-34 **blocked** — [PM40](PM40_CODEX_STRICT_RETRY_BLOCKED.md) |
...
| **PM-45 runner hardening** | **PASS** (dry-run only) — [PM45](PM45_CODEX_RUNNER_HARDENING.md) |
| **PM-46 runner probe v2** | **FAIL** — [PM46](PM46_CODEX_LOCAL_RUNNER_PROBE_V2.md) · exit 2, `cli_exit_nonzero` |
...
| **PM-64 governance map cleanup** | **PASS** (docs-only) — [PM64](PM64_OPENCLAW_GOVERNANCE_MAP_CLEANUP.md) |
| **PM-65 decision boundary review** | **PASS** (docs-only) — [PM65](PM65_OPENCLAW_DECISION_BOUNDARY_REVIEW.md) |
...
| **PM-80 evidence capture design** | **DESIGN** (docs-only) — [PM80](PM80_OPENCLAW_RUNTIME_EVIDENCE_CAPTURE_DESIGN.md) · evidence contract · PM-34 **blocked** · `n8n_ready` **false** |
| **PM-34 preview smoke** | **PASS** (mock-worker only) — workflow `40` Gate D / PM21 preview ×2 — [smoke](sessions/2026-05-23-control-plane-pm34-runtime-smoke-gate-d-preview-pass.md) · [next gate](sessions/2026-05-23-control-plane-pm34-next-runtime-gate-preview-pass.md); real worker **blocked** |
| **OpenClaw / PM-34 gate (current)** | strict_pass dry-run **dry_run_pass** (mock-worker, `537e3ea`) — [result](sessions/2026-05-23-control-plane-pm34-strict-pass-dry-run-result.md) · no Codex/real worker · PM-34 **gated** · `n8n_ready` **false** · `strict_pass_candidate` **false** · [handoff](sessions/2026-05-23-control-plane-new-chat-handoff-after-pm34-dryrun.md) |
