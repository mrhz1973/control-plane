...
**Last consolidated:** after **02F redacted export** committed (PM-08 **PASS**). MVP **accepted-with-exception** (D-C1-A). Update when criterion or runtime posture changes.
...
- **Post-MVP:** PM-02 + PM-06 + PM-07 + PM-08 **PASS** — [POST_MVP_BACKLOG.md](POST_MVP_BACKLOG.md)
