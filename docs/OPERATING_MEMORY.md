...
- I comandi che l'operatore esegue a mano — PowerShell, git, shell, terminale, ssh — vanno dati **uno alla volta**: un singolo comando, si attende l'output, poi il successivo.
...
- Prima di comandi remoti o `ssh`, indicare sempre host, contesto e destinazione corretti.
