...
**PM-50 PASS:** OpenClaw install/onboard — [PM50](PM50_OPENCLAW_LOCAL_INSTALL_ONBOARD_PASS.md). **PM-51:** **PREPARED / NOT EXECUTED** — [handoff new chat](handoffs/pm-51-openclaw-confined-gateway-noop-probe-new-chat.md) · [PM51](PM51_OPENCLAW_CONFINED_GATEWAY_NOOP_PROBE_GATE.md). **PM-34:** **blocked**.
