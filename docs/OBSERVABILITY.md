...
| **Runtime** | **Not** authorized by this file; each n8n/Telegram/webhook/**delete** = **one** [RUNTIME_GATES.md](RUNTIME_GATES.md) gate; record UI cleanup in a session note, then batch doc alignment |
...
| **MVP posture** | **D-C1-A** accepted; C1 **PARTIAL**; **`40`** sole ACTIVE workflow; final n8n list **4** workflows; PM-09 **C+D+FILE PASS**; v5 **off**; webhook **not configured** |
