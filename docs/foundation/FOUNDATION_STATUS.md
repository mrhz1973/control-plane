...
**Updated:** 2026-05-25 (no-provider-API bridge discovery complete)
...
| **OpenClaw/Codex bridge** | **DISCOVERY** | **Recommend:** Codex-first local bridge (Codex CLI OAuth + optional gateway transport); [discovery v1](../contracts/openclaw-codex-bridge-discovery-v1.md) · [session](../sessions/2026-05-25-control-plane-openclaw-codex-bridge-discovery-complete.md) |
...
| **Next tactical step** | pending | **Codex bridge contract v1** (docs) then **manual Codex CLI read-only smoke** on Ryzen — no OpenClaw agent, no provider API key, no n8n — [discovery v1](../contracts/openclaw-codex-bridge-discovery-v1.md) |
