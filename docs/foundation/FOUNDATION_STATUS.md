...
**Updated:** 2026-05-25 (classifier wrapper contract design complete)
...
| **Classifier wrapper contract** | **DESIGN** | [classifier-wrapper-v1](../contracts/classifier-wrapper-v1.md); [session](../sessions/2026-05-25-control-plane-classifier-wrapper-contract-design.md) — no runtime yet |
...
| **Next tactical step** | pending | OpenClaw ↔ Codex ↔ Ollama ↔ Cursor local path (manual first) — [PROJECT_VISION §12](PROJECT_VISION.md#12-prossimi-passi-tattici-verso-la-visione) |
