...
| **Next** | **PM-44** real local runner probe **or** stabilize |
...
| **PM-34** | **Blocked** |
| **Next** | **PM-44** real local runner probe |
...
|-------|--------|
| **Status** | **PREPARED / NOT EXECUTED** (2026-05-22) |
| **Packet** | [pm-44-real-local-codex-runner-probe-gate.md](runtime-packets/pm-44-real-local-codex-runner-probe-gate.md) |
| **Why** | Run `codex.cmd` via wrapper; capture stdout; PM-43 parser validation |
