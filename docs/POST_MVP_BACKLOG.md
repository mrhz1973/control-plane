...
| **Next** | **PM-51** OpenClaw gateway no-op **or** PM-52 bridge design **or** stabilize |
...
| Field | Value |
|-------|--------|
| **Status** | **PASS WITH OUTPUT-FORMAT DEVIATION** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm36-codex-repo-read-probe-pass.md) |
...
### PM-37 — Exact-output harness

| Field | Value |
|-------|--------|
| **Status** | **PASS** (2026-05-22) — mock validator — [batch](sessions/2026-05-22-control-plane-pm37-pm38-codex-exact-output-harness.md) |
| **Doc** | [PM37_CODEX_EXACT_OUTPUT_HARNESS.md](PM37_CODEX_EXACT_OUTPUT_HARNESS.md) |
| **Tool** | `tools/codex-exact-output-harness-dry-run.mjs` |
| **Why** | PM-36 format deviation — marker + JSON before n8n parses Codex output |
| **Out of scope** | Codex invocation; worker enable |

---

### PM-38 — Real structured Codex output probe
...
### PM-39 — Strict harness hardening

| Field | Value |
|-------|--------|
| **Status** | **PASS** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm39-codex-strict-harness-hardening.md) |
| **Doc** | [PM39_CODEX_STRICT_HARNESS_HARDENING.md](PM39_CODEX_STRICT_HARNESS_HARDENING.md) |
...
### PM-40 — Real Codex strict structured retry
...
| Field | Value |
|-------|--------|
| **Status** | **STRICT OUTPUT FAIL / SCOPE DRIFT** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm41-fail-pm42-pm43-adapter-design.md) |
| **Doc** | [PM41_CODEX_EXTERNAL_STRICT_RETRY_FAIL.md](PM41_CODEX_EXTERNAL_STRICT_RETRY_FAIL.md) |
| **PM-34** | **Blocked** |
| **Next** | **PM-43** adapter dry-run |
...
| **Doc** | [PM42_CODEX_ADAPTER_RUNNER_DESIGN.md](PM42_CODEX_ADAPTER_RUNNER_DESIGN.md) |
| **Why** | External runner validates stdout; n8n never consumes raw Codex text |
...
| Field | Value |
|-------|--------|
| **Status** | **PASS / DRY-RUN ONLY** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm43-codex-adapter-runner-dry-run.md) |
| **Doc** | [PM43_CODEX_ADAPTER_RUNNER_DRY_RUN.md](PM43_CODEX_ADAPTER_RUNNER_DRY_RUN.md) |
| **Tool** | `tools/codex-adapter-runner-dry-run.mjs` |
| **PM-34** | **Blocked** |
| **Next** | **PM-51** gateway no-op **or** PM-48 fallback |

---

### PM-44 — Real local Codex runner probe

| Field | Value |
|-------|--------|
| **Status** | **FAIL** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm44-codex-local-runner-probe.md) |
| **Doc** | [PM44_CODEX_LOCAL_RUNNER_PROBE.md](PM44_CODEX_LOCAL_RUNNER_PROBE.md) |
...
| Field | Value |
|-------|--------|
| **Status** | **FAIL** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm46-codex-local-runner-v2.md) |
| **Doc** | [PM46_CODEX_LOCAL_RUNNER_PROBE_V2.md](PM46_CODEX_LOCAL_RUNNER_PROBE_V2.md) |
| **Tool** | `tools/codex-local-runner-probe-v2.mjs` |
| **failure_mode** | **cli_exit_nonzero** (exit 2, no strict markers) |
| **PM-34** | **Blocked** |
| **Next** | [PM-47 diagnosis](PM47_CODEX_RUNNER_CLI_DIAGNOSIS.md) |
...
| Field | Value |
|-------|--------|
| **Status** | **PASS / DIAGNOSIS ONLY** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm47-codex-runner-cli-diagnosis.md) |
| **Doc** | [PM47_CODEX_RUNNER_CLI_DIAGNOSIS.md](PM47_CODEX_RUNNER_CLI_DIAGNOSIS.md) |
| **Hypothesis** | CLI argv differs from manual known-good; PM-46 `--approval` likely invalid |
| **PM-34** | **Blocked** |
| **Next** | **PM-51** gateway no-op **or** PM-48 fallback |

---

### PM-48 — Real local Codex runner probe v3

| Field | Value |
|-------|--------|
| **Status** | **PREPARED / NOT EXECUTED** (2026-05-22) — **fallback** track |
| **Packet** | [pm-48-real-local-codex-runner-v3-gate.md](runtime-packets/pm-48-real-local-codex-runner-v3-gate.md) |
| **Config** | [pm47-codex-runner-v3-config.sample.json](examples/pm47-codex-runner-v3-config.sample.json) |
| **Why** | Known-good argv without `--approval`; one-shot only |
...
| Field | Value |
|-------|--------|
| **Status** | **PASS / FEASIBILITY ONLY** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm49-openclaw-oauth-bridge-feasibility.md) |
| **Doc** | [PM49_OPENCLAW_OAUTH_BRIDGE_FEASIBILITY.md](PM49_OPENCLAW_OAUTH_BRIDGE_FEASIBILITY.md) |
| **PM-34** | **Blocked** |
| **Provider fallback** | OpenRouter/Gemini **blocked** — separate gate required |
| **Next** | **PM-50** if OpenClaw track chosen |
...
| Field | Value |
|-------|--------|
| **Status** | **PASS / RUNTIME MANUAL CONTROLLED** (2026-05-22) — [session](sessions/2026-05-22-control-plane-pm50-openclaw-local-onboard-pass.md) |
| **Doc** | [PM50_OPENCLAW_LOCAL_INSTALL_ONBOARD_PASS.md](PM50_OPENCLAW_LOCAL_INSTALL_ONBOARD_PASS.md) |
| **PM-34** | **Blocked** |
| **Next** | **PM-51** gateway no-op probe |

---

### PM-51 — OpenClaw confined gateway no-op probe

| Field | Value |
|-------|--------|
| **Status** | **PREPARED / NOT EXECUTED** (2026-05-22) |
| **Doc** | [PM51_OPENCLAW_CONFINED_GATEWAY_NOOP_PROBE_GATE.md](PM51_OPENCLAW_CONFINED_GATEWAY_NOOP_PROBE_GATE.md) |
| **Packet** | [pm-51-openclaw-confined-gateway-noop-probe-gate.md](runtime-packets/pm-51-openclaw-confined-gateway-noop-probe-gate.md) |
| **Why** | First safe gateway use after PM-50; loopback only |
...
| **Prerequisites** | PM-42/43 runner **strict_pass** artifact before runtime; stable `40`; `41` retained — **PM-41 fail does not unblock** |
