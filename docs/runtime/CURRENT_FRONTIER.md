...
| **NEXT** | `V4_LOCAL_DEV_EXECUTOR_BACKLOG_ENVELOPE_BRIDGE_DRY_RUN_V1` — smoke CLI-shape del ponte su commit reale: produce preview envelope+receipt (nessuna esecuzione), chiude il divario tra funzione pura testata (18/18) e forma CLI persistita |
