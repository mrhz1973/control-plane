...
| **ACTIVE WORK** | issue **#31 D-0025-W** — Attempt 14 reached packet schema; missing required field `allowed_paths` |
| **BLOCCO ATTIVO** | `D0025_W_LITELLM_PRIMARY_REMOTE_INTEGRATION` |
| **STATO BLOCCO** | `PROVIDER_CONFIG_WIRED / FULLRESPONSE_UNWRAP_LIVE_PROVEN / PACKET_SCHEMA_INVALID_ALLOWED_PATHS / REMOTE_RUNTIME_GATE_DISABLED` |
| **GATE CORRENTE** | **CLOSED** — one live event used; do not reopen until offline required-field remediation is authorized |
| **NEXT** | Offline remediate `PACKET_SCHEMA_INVALID` (`Missing required field: allowed_paths`); keep unwrap + prior instruction hardening; no live retry until authorized |
