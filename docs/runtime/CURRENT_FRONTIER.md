...
| **NEXT** | Remaining GOI private slices on NEW (ORS/GIS/Nav/D-Flight/nginx as separately authorized) → schema-engine qualification → restart-persistence/parallel validation · human cutover GATE · OpenClaw activate-or-archive human decision |
