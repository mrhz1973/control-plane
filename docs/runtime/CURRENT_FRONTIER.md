...
Ultimo aggiornamento: 2026-05-31 — Wf47 Data Table manual validation PASS
...
- Prossimo gate reale: decide whether to prepare a registration package for operational-style inbound Decision Packet state correlation, still manual/inactive/off and without schedule; any schedule, production Data Table, or PM-34 remains a separate gate. Wf47 repeated manual polling on test-only wf47_polling_state_test is PASS; not operational inbound automation.
