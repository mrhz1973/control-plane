...
| **MICRO_TASK_DELTA LAW** | `docs/foundation/MICRO_TASK_DELTA_OPERATING_LAW.md` — **CANONICAL** (#42) · **ADMISSION PARITY LIVE** (#48) · **SAFE FF SYNC CODE_WIRED** (#49 at `ac3df9a`/`2623aad`) · **LIVE APPLY #50 STOP** — BASE_HEAD drift (`ac3df9a` required; observed `2623aad`); no dispatcher restart performed; FF sync still requires re-authorized live apply at current HEAD |
