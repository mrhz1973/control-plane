...
| **ACTIVE WORK** | issue **#27** `D-0021-W` **COMPLETE**; issue **#26 D-0020-W** COMPLETE; issue **#25 D-0019-W** COMPLETE; issue **#24 D-0018-W** COMPLETE; issue **#23 D-0017-W** COMPLETE; issue **#22 D-0016-W** Phase B authorized but HOME host offline; issue **#8** Z.AI VPS/provider support parallel |
| **BLOCCO ATTIVO** | none for D-0021-W |
| **STATO BLOCCO** | `D0021_W_COMPLETE / D0020_W_COMPLETE / D0016_W_PHASE_B_AUTHORIZED_HOME_HOST_OFFLINE / ZAI_SUPPORT_WAIT_PARALLEL` |
| **GATE CORRENTE** | `D0021_W_COMPLETE` — deterministic `PROCEED\|GATE\|BLOCKED` policy evaluator implemented and tested; schema max_rounds/max_review_rounds parity enforced; no Cursor/Telegram/runtime dispatch |
...
- No public exposure, destructive action, VPS Z.AI mutation, PM-34/L5/endurance/permanent schedule, Cursor/Telegram dispatch from this policy tool, or Windows-primary promotion is authorized.
