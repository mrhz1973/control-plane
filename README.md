...
| PM-79 OpenClaw second gateway probe (PASS) | [docs/PM79_OPENCLAW_CONTROLLED_SECOND_GATEWAY_PROBE.md](docs/PM79_OPENCLAW_CONTROLLED_SECOND_GATEWAY_PROBE.md) · [session](docs/sessions/2026-05-22-control-plane-pm79-openclaw-controlled-second-gateway-probe-pass.md) |
| PM-80 OpenClaw runtime evidence design | [docs/PM80_OPENCLAW_RUNTIME_EVIDENCE_CAPTURE_DESIGN.md](docs/PM80_OPENCLAW_RUNTIME_EVIDENCE_CAPTURE_DESIGN.md) · [session](docs/sessions/2026-05-23-control-plane-pm80-openclaw-runtime-evidence-capture-design.md) |
...
| PM-59–63 OpenClaw governance batch | [PM63 handoff](docs/PM63_OPENCLAW_GOVERNANCE_CHECKPOINT_HANDOFF.md) · [batch session](docs/sessions/2026-05-22-control-plane-pm59-pm63-openclaw-governance-batch.md) · [PM60 tool](tools/validate-openclaw-lifecycle-metadata.mjs) |
| PM-64–68 OpenClaw governance cleanup | [PM68 compact handoff](docs/PM68_OPENCLAW_NEW_CHAT_COMPACT_HANDOFF.md) · [PM64 map](docs/PM64_OPENCLAW_GOVERNANCE_MAP_CLEANUP.md) · [batch session](docs/sessions/2026-05-22-control-plane-pm64-pm68-openclaw-governance-cleanup-batch.md) |
| PM-69–73 OpenClaw governance index (PASS) | [PM68 handoff](docs/PM68_OPENCLAW_NEW_CHAT_COMPACT_HANDOFF.md) · [PM69 index](docs/PM69_OPENCLAW_GOVERNANCE_INDEX_CLEANUP.md) · [PM73 checkpoint](docs/PM73_OPENCLAW_GOVERNANCE_CLEANUP_CHECKPOINT.md) |
| PM-74–78 OpenClaw lifecycle hardening (PASS) | [PM78](docs/PM78_OPENCLAW_LIFECYCLE_HARDENING_CHECKPOINT.md) · [PM74 transitions](docs/PM74_OPENCLAW_LIFECYCLE_TRANSITION_RULES_DESIGN.md) · [tool](tools/validate-openclaw-lifecycle-metadata.mjs) |
