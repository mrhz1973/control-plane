...
| PM-74–78 OpenClaw lifecycle hardening (PASS) | [PM78 checkpoint](docs/PM78_OPENCLAW_LIFECYCLE_HARDENING_CHECKPOINT.md) · [PM75](docs/PM75_OPENCLAW_LIFECYCLE_VALIDATOR_TRANSITION_HARDENING.md) · [lifecycle tool](tools/validate-openclaw-lifecycle-metadata.mjs) |
