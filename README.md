...
| PM-33 Codex OAuth login gate (prepared) | [docs/runtime-packets/pm-33-codex-oauth-manual-login-gate.md](docs/runtime-packets/pm-33-codex-oauth-manual-login-gate.md) |
