# Backlog item — D-9401-B (#73 ChatGPT Web static access-surface registration retry)

```yaml
schema: backlog-item-v1
id: D-9401-B
title: Register ChatGPT Web via Hermes as a static v2 access surface without quota inference — retry after Qwen READY
created_at: 2026-09-07T20:44:00Z
created_by: gpt-web
repository: mrhz1973/control-plane
branch_target: main

objective: |
  Retry the bounded D-9401-A slice after the prior attempt stopped pre-generation with QWEN_SESSION_NOT_READY/API_UNREACHABLE.
  ...
  7. Add focused assertions in tests/registry-v2/run.mjs proving:
     ...
     - v1 `resources` projection remains unchanged by this slice.
...
scope:
  ...
  forbidden_areas:
    ...
    - .github/**
  notes:
    - D-9401-A is historical/stale after a pre-generation Qwen readiness STOP; do not mutate that receipt in this task.
...
context_refs:
  ...
  - github:mrhz1973/control-plane#75
